...
COMMON_SPECS = [
    EntitySpec("sensor", "rssi", "RSSI", "{{ value_json.pyswitchbot.rssi }}", "signal_strength", "measurement", "dBm"),
]
...
DEVICE_TYPE_SPECS: dict[str, list[EntitySpec]] = {
    "MeterPro(CO2)": [
        EntitySpec(
            ...
            "temperature",
            "Temperature",
            "{{ value_json.pyswitchbot.data.data.temperature }}",
            "temperature",
            "measurement",
            "°C",
        ),
        EntitySpec(
            ...
            "humidity",
            "Humidity",
            "{{ value_json.pyswitchbot.data.data.humidity }}",
            "humidity",
            "measurement",
            "%",
        ),
        EntitySpec(
            ...
            "co2",
            "CO2",
            "{{ value_json.pyswitchbot.data.data.co2 }}",
            "carbon_dioxide",
            "measurement",
            "ppm",
        ),
    ...
    "Hub 2": [
        ...
        EntitySpec(
            ...
            "illuminance",
            "Illuminance",
            "{{ value_json.pyswitchbot.data.data.illuminance }}",
            "illuminance",
            "measurement",
            "lx",
        ),
        EntitySpec(
            ...
            "light_level",
            "Light Level",
            "{{ value_json.pyswitchbot.data.data.lightLevel }}",
            None,
            "measurement",
            None,
        ),
    ...
    "Plug Mini (JP)": [
        EntitySpec(
            ...
            "power_state",
            "Power State",
            "{{ value_json.pyswitchbot.data.data.isOn }}",
            "power",
            None,
            None,
            "True",
        ...
        EntitySpec(
            ...
            "power",
            "Power",
            "{{ value_json.pyswitchbot.data.data.power }}",
            "power",
            "measurement",
            "W",
        ),
        EntitySpec(
            ...
            "wifi_rssi",
            "Wi-Fi RSSI",
            "{{ value_json.pyswitchbot.data.data.wifi_rssi }}",
            "signal_strength",
            "measurement",
            "dBm",
        ),
    ...
    "Strip Light": [
        ...
        EntitySpec(
            ...
            "brightness",
            "Brightness",
            "{{ value_json.pyswitchbot.data.data.brightness }}",
            None,
            "measurement",
            "%",
        ),
